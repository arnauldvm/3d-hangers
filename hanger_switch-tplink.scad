       ...
       translate([0, 0, rounding_mm])
        union() {
            ...
            difference() {
                ...
                translate([-inner_kernel_width_mm/2-2*rounding_mm,thickness_mm+rounding_mm-2*rounding_mm])
                    square([inner_kernel_width_mm+4*rounding_mm, inner_kernel_depth_mm+4*rounding_mm]);
